...
func main() {
	...
	newClient := Client{
		FIO:      "Leo Messi",         // укажите ФИО
		Login:    "leo10Barca",        // укажите логин
		Birthday: "19900101",          // укажите день рождения
		Email:    "messi10@gmail.com", // укажите почту
	}
	...
	newLogin := "leo10InterMiami" // укажите новый логин
